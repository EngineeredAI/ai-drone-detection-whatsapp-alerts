...
set=0
def alert_snd():
    #wave_obj = sa.WaveObject.from_wave_file("D:\\TF PROGRAM\\yolov5\\asleep.wav")
...
class Annotator:
    ...
    def box_label_seg(self,j, box, label='', color=(128, 128, 128), txt_color=(255, 255, 255)):
    ...
    def box_label(self, box, label='', color=(128, 128, 128), txt_color=(255, 255, 255)):
        ...
        if self.pil or not is_ascii(label):
            ...
            if label:
                ...
                print(sized)
                # 153900 k factor for 175cms ht person
                #38000 for face
                k=114550
                dist=(float(1/sized*k))
                ...
                #print("left zone")
                cv2.putText(self.im,
                            label+""+dist2, (p1[0], p1[1] - 2 if outside else p1[1] + h + 2),
                            0,
                            self.lw / 3,
                            txt_color,
                            thickness=tf,
                ...
                #cv2.circle(self.im,(mpx,mpy),radius=5,color=(0,0,255),thickness=cv2.FILLED)
                maxlen=16
